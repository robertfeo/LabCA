...
;
;   Author:   	   J.Friedrich
;   Last Modified: W.Zimmermann, Jul 4, 2019
;
;   Usage:
...
;**************************************************************
; Public interface function: writeLine ... schreibe zero-terminated string in LCD
; Parameter: X ... pointer auf string
;            B ... Zeile(0 or 1)
; Return:    -
; Bugs:      Fixed bugs/missing features markiert mit **
writeLine:
          pshd
          pshx
          pshb
...
next:     ldaa 0,x        ; get character
          ...
          bra  next       ;
pad:      ldaa #$20       ; ** load space character in Reg-A
          decb            ; ** space for remaining characters
          beq  wEnd       ; **
          jsr  outputByte ; **
          bra  pad        ; ** 
wEnd:     pulx            ;
